...
open class SVNModalViewController: UIViewController {
  ...
  public lazy var dismissMeta: SVNShapeMetaData = {
  ...
  public func modalSubviews(shouldHide hide: Bool){
    dismissButton.isEnabled = hide
    dismissMeta.shapes?.forEach({ $0.opacity = hide ? 0.0 : 1.0 })
  }
